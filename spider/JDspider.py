...
class JDspider():
    def start(self):
        # 启动爬虫
        test_data = {'project':'Jdcomments', 'spider':'jingdongproducts'}
    ...
    def cancel(self,jobid):
        ...
        # 停止爬虫
        test_data = {'project': 'Jdcomments', 'job': jobid_master}
        test_data_urlencode = urllib.urlencode(test_data)

        test_data1 = {'project': 'Jdcomments', 'job': jobid_server}
