...
class WYspider():
    def start(self):
        # 启动爬虫
        test_data = {'project':'wangyi', 'spider':'technewsspider'}
    ...
    def cancel(self,jobid):
        ...
        # 停止爬虫
        test_data = {'project': 'wangyi', 'job': jobid_master}
        test_data_urlencode = urllib.urlencode(test_data)

        test_data1 = {'project': 'wangyi', 'job': jobid}
        test_data_urlencode1 = urllib.urlencode(jobid_server)
